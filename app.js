...
window.addEventListener("load", async ()=>{
  ...
  $("cur-project").onchange=async e=>{ CUR.project=e.target.value; metaSet("cur_project",CUR.project); await SyncEngine.pull(); renderDashboard(); renderMySubs(); renderContractors(); renderTiendo(); renderCdt(); renderTeam(); updateProjBanner(document.querySelector(".nav-btn.active, .sub-btn.active")?.dataset.tab); syncKBToIframe(); };
